...
export const BLOCK_SHORTCUTS = {
  ...
  italic: { code: 'KeyI' },
  underline: { code: 'KeyU' },
  strike: { code: 'KeyS', shift: true },
  link: { code: 'KeyK' },
  fontSizeSmall: { code: 'Digit6', alt: true },
  fontSizeBody: { code: 'Digit7', alt: true },
  fontSizeMedium: { code: 'Digit8', alt: true },
  fontSizeLarge: { code: 'Digit9', alt: true },
  fontSizeXLarge: { code: 'Digit0', shift: true },
  ...
  taskList: { code: 'Digit9', shift: true },
